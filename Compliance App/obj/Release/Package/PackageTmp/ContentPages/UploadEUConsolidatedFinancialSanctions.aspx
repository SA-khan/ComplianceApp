<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FrontendWithoutSidebar.Master" AutoEventWireup="true" CodeBehind="UploadEUConsolidatedFinancialSanctions.aspx.cs" Inherits="Compliance_App.ContentPages.UploadEUConsolidatedFinancialSanctions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
        <asp:Label ID="Label1" runat="server" Text="Upload EU Consolidated Financial Sanctions" BackColor="DarkRed" ForeColor="White" CssClass="BaseName"></asp:Label>
        <br />
        <br />
        <br />
        <br />
                ...
                <thead>
                    ...
                    <tr>
                      <th id="heading" colspan="3" style="text-align:center;">
                        <span style="font-size:large;font-family:Arial;text-align:center;margin:auto;">EU Consolidated Financial Sanctions DATA UPLOAD PANEL</span>
                      </th>
                    </tr>
                </thead>
                <tbody>
