...
{
    public partial class UploadFIAMostWantedCyberCrimeCircle : System.Web.UI.Page
    {
                            ...
                            try
                            {
                                ...
                                while (reader.ReadRow(row))
                                {
                                    ...
                                    if (i > 1)
                                    {
                                        ...
                                        try
                                        {
                                            result = cls.InsertFIAMostWantedCyberCrimeCircleData(Column1, Column2, Column3, Column4);
                                        }
                                        catch (Exception ex)
                                        {
