<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FrontendWithoutSidebar.Master" AutoEventWireup="true" CodeBehind="UploadOFACSpeciallyDesignatedNationalsAndBlockedEntities.aspx.cs" Inherits="Compliance_App.ContentPages.UploadOFACSpeciallyDesignatedNationalsAndBlockedEntities" %>
                ...
                <thead>
                    ...
                    <tr>
                      <th id="heading" colspan="3" style="text-align:center;">
                        <span style="font-size:large;font-family:Arial;text-align:center;margin:auto;">OFAC Specially Designated Nationals And Blocked Entities DATA UPLOAD PANEL</span>
                      </th>
                    </tr>
                </thead>
                <tbody>
