<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FrontendWithoutSidebar.Master" AutoEventWireup="true" CodeBehind="UploadFIAMostWantedTerrorists.aspx.cs" Inherits="Compliance_App.ContentPages.UploadFIAMostWantedTerrorists" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
        <asp:Label ID="Label1" runat="server" Text="Upload FIA Most Wanted Terrorists Data" BackColor="DarkRed" ForeColor="White" CssClass="BaseName"></asp:Label>
        <br />
        <br />
        <br />
        <br />
                ...
                <thead>
                    ...
                    <tr>
                      <th id="heading" colspan="3" style="text-align:center;">
                        <span style="font-size:large;font-family:Arial;text-align:center;margin:auto;">FIA Most Wanted Terrorists DATA UPLOAD PANEL</span>
                      </th>
                    </tr>
                </thead>
                <tbody>
