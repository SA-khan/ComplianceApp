<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FrontendWithoutSidebar.Master" AutoEventWireup="true" CodeBehind="UploadProscribedOrganisationNACTA.aspx.cs" Inherits="Compliance_App.ContentPages.UploadProscribedOrganisationNACTA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
        <asp:Label ID="Label1" runat="server" Text="Upload Proscribed Organisation NACTA Data" BackColor="DarkRed" ForeColor="White" CssClass="BaseName"></asp:Label>
        <br />
        <br />
        <br />
        <br />
                ...
                <thead>
                    ...
                    <tr>
                      <th id="heading" colspan="3" style="text-align:center;">
                        <span style="font-size:large;font-family:Arial;text-align:center;margin:auto;">Proscribed Organisation NACTA DATA UPLOAD PANEL</span>
                      </th>
                    </tr>
                </thead>
                <tbody>
