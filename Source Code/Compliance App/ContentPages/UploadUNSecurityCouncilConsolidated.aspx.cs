...
{
    public partial class UploadUNSecurityCouncilConsolidated : System.Web.UI.Page
    {
                            ...
                            try
                            {
                                ...
                                while (reader.ReadRow(row))
                                {
                                    ...
                                    if (i > 1)
                                    {
                                        ...
                                        try
                                        {
                                            result = cls.InsertUNSecurityCouncilConsolidatedData(Column1, Column2, Column3, Column4);
                                        }
                                        catch (Exception ex)
                                        {
